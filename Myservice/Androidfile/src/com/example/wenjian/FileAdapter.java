...
public class FileAdapter extends BaseAdapter {
	...
	public FileAdapter(Context context, List<String> it, List<String> pa) {
		...
		paths = pa;
		/** 返回跟目录 图片*/
		mIcon1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.backroot);
		/** 返回上一级 图片*/
		mIcon2 = BitmapFactory.decodeResource(context.getResources(), R.drawable.backparent);
		/** 所有文件夹 图片*/
