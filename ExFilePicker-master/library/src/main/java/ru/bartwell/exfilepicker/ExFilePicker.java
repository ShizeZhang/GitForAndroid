...
public class ExFilePicker {
    ...
    private boolean mIsNewFolderButtonDisabled = true;
    private boolean mIsSortButtonDisabled = true;
    private boolean mIsQuitButtonEnabled = true;
    @NonNull
    ...
    private boolean mUseFirstItemAsUpEnabled = true;
    private boolean mHideHiddenFilesEnabled = true;
